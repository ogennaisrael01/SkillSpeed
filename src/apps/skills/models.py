...
class SkillCategory(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="category")
    category_id = models.UUIDField(primary_key=True, unique=True, max_length=20, default=uuid.uuid4)
    name = models.CharField(max_length=200, choices=Category.choices, default=None, null=True, unique=True)
...
class Skills(models.Model):
    ...
    skill_id = models.UUIDField(default=uuid.uuid4, primary_key=True, unique=True, max_length=20)
    ...
    skill_difficulty = models.CharField(max_length=20, choices=SkillDifficulty.choices, default=SkillDifficulty.BEGINNER)
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["is_active", "is_deleted"], name="deleted_active_idx")
        ]

class Enrollment(models.Model):
    enrol_id = models.UUIDField(primary_key=True, unique=True, max_length=20, default=uuid.uuid4)

    child_profile = models.ForeignKey(ChildProfile, on_delete=models.CASCADE, related_name="enrollment")
    skill = models.ForeignKey(Skills, on_delete=models.CASCADE, related_name="enrollment")
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=["child_profile", "skill"], name="unique_profile_and_skill")
        ]

    def __str__(self):
        return "Enrollment({}, {})".format(self.child_profile.first_name, self.skill.name)
