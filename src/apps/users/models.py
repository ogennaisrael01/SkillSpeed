...
class PasswordReset(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=["reset_code", "user"], name="unique_reset_code_user"),
            models.UniqueConstraint(fields=["reset_token", "user"], name="unique_reset_user_user")
        ]

        indexes = [
            models.Index(fields=["is_active"], name="is_active_idx"),
            models.Index(fields=["is_active", "user", "reset_code"], name="active_codes_idx")
        ]
