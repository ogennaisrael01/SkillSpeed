...
class TestUserAuth(TestCase):
    def setUp(self):
        user = User.objects.create(email="testuser@example.com", password="test-password")
    ...
    def test_send_email_to_user(self):
        context = {"code": "303030", "email": "testuser@example.com", "verification_url": "http://example.com/verify",
